...
class Integer extends Base
{
    ...
    {
        parent::__construct('int', $title, $field);
    }
    ...
    {
        return '    public int '.$this->field.';';
    }
    
    public function toFromMap()
    {
        return '        entity.'.$this->field.' = Integer.valueOf(data.get("'.$this->field.'"));';
    }
    
    public function toFromJson()
    {
        return '        entity.'.$this->field.' = json.get("'.$this->field.'").getAsInt();';
    }
